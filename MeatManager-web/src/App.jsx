...
const InformesCortes = lazyWithRecovery(() => import('./pages/InformesCortes'));
          ...
          <Routes key={location.pathname}>
            ...
            <Route element={<RequireAuth />}>
              <Route path="/" element={<DashboardLayout />}>
                ...
                <Route path="informes-cortes" element={protect('/informes-cortes', lazyElement(InformesCortes))} />
